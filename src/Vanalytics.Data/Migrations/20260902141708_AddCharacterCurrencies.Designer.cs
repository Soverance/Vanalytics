...
namespace Vanalytics.Data.Migrations
{
    ...
    [Migration("20260902141708_AddCharacterCurrencies")]
    partial class AddCharacterCurrencies
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Soverance.Auth.Models.User", b =>
                {
                    ...
                    b.Property<string>("ApiKeyLookup")
                        .HasMaxLength(64)
                    ...
                    b.HasIndex("ApiKeyLookup")
                        .IsUnique()
                        .HasFilter("[ApiKeyLookup] IS NOT NULL");
            ...
            modelBuilder.Entity("Vanalytics.Core.Models.AchievementRescoreState", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("AchievementRescoreStates");
                });

            modelBuilder.Entity("Vanalytics.Core.Models.AhScrapeState", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ServerId", "LastScrapedAt");

                    b.HasIndex("ServerId", "ItemId", "Stack")
                        .IsUnique();

                    b.ToTable("AhScrapeStates");
                });
            ...
            modelBuilder.Entity("Vanalytics.Core.Models.CharacterCurrencies", b =>
                {
                    b.Property<Guid>("CharacterId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Vanalytics.Core.Models.GameServer", b =>
                {
                    ...
                    b.Property<bool>("ScrapeEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<string>("SearchHost")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.Property<int?>("SearchPort")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vanalytics.Core.Models.CharacterCurrencies", b =>
                {
                    b.HasOne("Vanalytics.Core.Models.Character", "Character")
                        .WithOne()
                        .HasForeignKey("Vanalytics.Core.Models.CharacterCurrencies", "CharacterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
