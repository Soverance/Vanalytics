...
export default function CompareInspector({ resource, op, value, valueWired, onChange }: {
  ...
  return (
    <div className="w-72 flex-none overflow-auto border-l border-gray-800 bg-gray-900 p-4">
      <h4 className="mb-2 text-[11px] uppercase tracking-wide text-gray-500">Compare</h4>
      {valueWired ? (
        <p className="mb-3 rounded border border-gray-700 bg-gray-800 px-2 py-1.5 text-xs text-gray-400">
          Value comes from the wired input.
        </p>
      ) : (
        <>
          <label className="mb-1 block text-xs text-gray-400">Value source</label>
