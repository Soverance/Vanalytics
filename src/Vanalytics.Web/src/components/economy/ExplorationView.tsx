...
export default function ExplorationView() {
  ...
  const fetchRandom = () => {
    setLoading(true)
    fetch('/api/items/random?count=6')
        ...
        >
          <div className="flex items-start gap-4 mb-4">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-gray-500 mt-2">View 3D Model &rarr;</p>
            </div>
          </div>
          ...
          {supporting.map((item) => (
            <div key={item.itemId} className="relative">
              <Link
                ...
                className="flex items-center gap-2 rounded-lg border border-gray-800 bg-gray-900 p-3 hover:border-gray-600 transition-colors"
